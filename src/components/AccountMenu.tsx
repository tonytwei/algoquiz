...
export default function NavMenu(props: {
  ...
  return (
    <div className="flex flex-row justify-center text-black gap-5 w-full max-w-[1000px]">
      <label
        htmlFor="saved"
        className={`flex flex-row justify-center w-1/5 gap-2 py-3 px-6 rounded-md border-4 border-solid cursor-pointer ${
          props.showSaved
      ...
      {props.inSession ? (
        <label
          className="flex flex-row justify-center w-1/5 gap-2 py-3 px-6 rounded-md border-4 border-solid bg-white border-gray-400 cursor-pointer"
          onClick={() => signOut()}
        >
          <Image
